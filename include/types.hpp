#ifndef METAKMEAN_17_TYPES_HPP
#define METAKMEAN_17_TYPES_HPP
...
constexpr f32 operator""_f32(const unsigned long long literal) noexcept {
...
constexpr f64 operator""_f64(const unsigned long long literal) noexcept {
